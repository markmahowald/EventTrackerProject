...
CREATE TABLE IF NOT EXISTS `transaction` (
  ...
  `income_or_expense` ENUM("income", "expense") NULL,
  `date` DATE NULL,
  `source` VARCHAR(100) NULL,
  `ammount` INT NOT NULL,
  `category` ENUM("Income", "Charity", "Clothing", "Fun Money", "Gifts", "Groceries", "Health", "Lifestyle", "Housing", "Saving", "Transportation", "Utilities", "Taxes") NULL,
  `account_id` INT NULL,
  PRIMARY KEY (`id`),
  CONSTRAINT `transactionToAccount`
...
CREATE INDEX `transactionToAccount_idx` ON `transaction` (`account_id` ASC);
...
START TRANSACTION;
USE `mydb`;
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (1, 'expense', '2019-01-01', 'VIET HOA SUPERMARKET LAKEWOOD CO Debit Card Withdrawal', 36.20, 'Groceries', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (4, 'income', '2019-01-02', 'VENMO ACH Deposit: VENMO', 10.00, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (7, 'expense', '2019-01-03', 'WF HOME MTG ACH Withdrawal: WF HOME MTG', 1,021.27, 'Mortgage', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (9, 'expense', '2019-01-03', 'SQ *DENVER MAC REPA DENVER CO Debit Card Withdrawal', 60.00, 'School', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (13, 'expense', '2019-01-04', 'CO-BREW DENVER CO Debit Card Withdrawal', 16.80, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (16, 'expense', '2019-01-06', 'DUFFER HAUS, LLC ENGLEWOOD CO Debit Card Withdrawal', 46.50, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (18, 'expense', '2019-01-06', 'RUPERTS AT THE EDGE EDGEWATER CO Debit Card Withdrawal', 27.41, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (20, 'expense', '2019-01-07', 'PETSMART # 1457 LITTLETON CO Debit Card Withdrawal', 49.89, 'Cats', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (26, 'expense', '2019-01-08', 'GOODWILL BEAR VALL DENVER CO Debit Card Withdrawal', 5.40, 'Clothes', 1);
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (27, 'income', '2019-01-10', 'PLANTRONICS INC ACH Deposit: PLANTRONICS INC', 1,385.43, 'Income', 1);
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (28, 'expense', '2019-01-10', 'PETSMART # 0230 LAKEWOOD CO Debit Card Withdrawal', 42.57, 'Cats', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (32, 'expense', '2019-01-12', 'CAFE ALLEGIRO GREENWOOD VLG CO Debit Card Withdrawal', 6.25, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (36, 'income', '2019-01-15', 'PAYPAL *RPPCENTERPR 402-935-7733 CA ADJ Debit Card Withdrawal: Credit Vouche', 60.00, 'School', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (46, 'expense', '2019-01-16', 'POSHMARK 650-488-7740 CA Debit Card Withdrawal', 21.49, 'Clothes', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (48, 'expense', '2019-01-17', 'Mark\'s Lunch - CAFE ALLEGIRO GREENWOOD VLG CO Debit Card Withdrawal', 11.39, 'Fun Money', 1);
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (49, 'expense', '2019-01-18', 'dodie concert tickets - AXS.COM*ROCKY MOUNTAIN 888-929-7849 CA Debit Card Withdrawal', 75.08, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (59, 'expense', '2019-01-22', 'Check Withdrawal', 4,000.00, 'School', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (63, 'expense', '2019-01-23', 'CAFE ALLEGIRO GREENWOOD VLG CO Debit Card Withdrawal', 4.67, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (67, 'income', '2019-01-24', 'PLANTRONICS INC ACH Deposit: PLANTRONICS INC', 1,385.41, 'Income', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (69, 'income', '2019-01-25', 'AMZN Mktp US Amzn.com/bill WA ADJ Debit Card Withdrawal: Credit Vouche', 8.20, 'Fun Money', 1);
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (70, 'expense', '2019-01-25', 'ABEBOOKS.CO FSXZ7R 8003155335 WA Debit Card Withdrawal', 16.04, 'School', 1);
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (71, 'expense', '2019-01-25', 'ABEBOOKS.CO FSXZ7S 8003155335 WA Debit Card Withdrawal', 15.01, 'School', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (74, 'expense', '2019-01-25', 'ALAMO DRAFTHOUSE SLOAN AUSTIN TX Debit Card Withdrawal', 14.48, 'Fun Money', 1);
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (75, 'expense', '2019-01-26', 'KING SOOP 5301 W. 38TH WHEAT RIDGE CO POS Withdrawal: #712157 - cat litter', 16.19, 'Cats', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (77, 'expense', '2019-01-27', 'KING SOOP 5125 W. FLOR DENVER CO POS Withdrawal: #824906', 70.00, 'Fun Money', 1);
...
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (, '', '', '', , '', );
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (, '', '', '', , '', );
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (, '', '', '', , '', );
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (, '', '', '', , '', );
INSERT INTO `transaction` (`id`, `income_or_expense`, `date`, `source`, `ammount`, `category`, `account_id`) VALUES (, '', '', '', , '', );
